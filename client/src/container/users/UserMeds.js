        ...
        <div className="AttrIndex">
          ...
          {this.props.selectedMed ? (
            <div className="AttrForm">
              ...
              <MedicationForm
                medication={this.props.selectedMed}
                action={"Edit"}
              />
              <Button bsstyle="link" onClick={this.props.editMed}>
                Cancel
              </Button>
            </div>
          ) : (
            this.props.isAddMed && (
              <div className="AttrForm">
                ...
                <MedicationForm />
                <Button bsstyle="link" onClick={this.props.addMed}>
                  Cancel
                </Button>
              </div>
            )
          ...
          {!this.props.selectedMed && !this.props.isAddMed && (
            <div className="AttrNew">
              <Button bsstyle="primary" onClick={this.props.addMed}>
                Add New Medication
              </Button>
            </div>
          )}
