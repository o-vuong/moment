    ...
    return (
      <div className="UserInsurances">
        ...
        <div className="AttrIndex">
          <div className="AttrTable">
            <Table striped bordered condensed hover>
              ...
              <Insurances
                ...
                editIns={this.props.editIns}
                deleteIns={this.props.deleteIns}
              />
            </Table>
          </div>

          {this.props.selectedIns ? (
            <div className="InsForm">
              <h3>Edit {this.props.selectedIns.name}</h3>
              <InsuranceForm
                insurance={this.props.selectedIns}
                action={"Edit"}
              />
              <Button bsstyle="link" onClick={this.props.editIns}>
                Cancel
              </Button>
            </div>
          ) : (
            this.props.isAddIns && (
              <div className="AttrForm">
                ...
                <InsuranceForm />
                <Button bsstyle="link" onClick={this.props.addIns}>
                  Cancel
                </Button>
              </div>
            )
          ...
          {!this.props.selectedIns && !this.props.isAddIns && (
            <div className="AttrNew">
              <Button bsstyle="primary" onClick={this.props.addIns}>
                Add New Insurance
              </Button>
            </div>
          )}
