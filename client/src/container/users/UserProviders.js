        ...
        <div className="AttrIndex">
          <div className="AttrTable">
            <Table striped bordered condensed hover>
              ...
              <Providers
                ...
                editProv={this.props.editProv}
                deleteProv={this.props.deleteProv}
              />
            </Table>
          </div>
          ...
          {this.props.selectedProv ? (
            <div className="ProvForm">
              ...
              <ProviderForm
                provider={this.props.selectedProv}
                action={"Edit"}
              />
              <Button bsstyle="link" onClick={this.props.editProv}>
                Cancel
              </Button>
            </div>
          ) : (
            this.props.isAddProv && (
              <div className="AttrForm">
                ...
                <ProviderForm />
                <Button bsstyle="link" onClick={this.props.addProv}>
                  Cancel
                </Button>
              </div>
            )
          ...
          {!this.props.selectedProv && !this.props.isAddProv && (
            <div className="AttrNew">
              <Button bsstyle="primary" onClick={this.props.addProv}>
                Add New Provider
              </Button>
            </div>
          )}
