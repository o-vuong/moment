...
class Login extends Component {
  ...
  render() {
    if (this.props.isAuthenticated) return <Redirect to="/user_profile" />;
      ...
      <main>
        <Form onSubmit={this.handleSubmit}>
          ...
          <TextFieldGroup
            ...
            onChange={this.handleChange}
            error={
              this.props.authFailure ? "Incorrect email / password." : null
            }
          />
          <div className="submissionFields">
            <Button type="submit" value="Login" bsstyle="primary">
              Log In
            </Button>
          </div>
          <div className="alternativeAccess">
            <p>
              New to moment? <a href="/signup">Sign Up</a>
            </p>
          </div>
        </Form>
      </main>
...
export default Login = withRouter(
  connect(mapStatesToProps, { authenticate })(Login)
);
